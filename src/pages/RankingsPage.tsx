...
export const RankingsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8 animate-in fade-in duration-300">
      ...
      <div className="p-4 rounded-2xl bg-emerald-50/80 border border-emerald-200/80 flex items-start gap-3.5 shadow-2xs">
        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-1 text-xs font-semibold text-emerald-900">
            <span className="px-2 py-0.5 rounded-md bg-white border border-emerald-200 shadow-2xs">
              1. IoT Simulation Score (/50)
            </span>
            <span>→</span>
            <span className="px-2 py-0.5 rounded-md bg-white border border-emerald-200 shadow-2xs">
              2. Technical Quiz Score (/50)
            </span>
            <span>→</span>
            <span className="px-2 py-0.5 rounded-md bg-white border border-emerald-200 shadow-2xs">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-900 text-white text-xs font-bold uppercase tracking-wider">
                  ...
                  <th className="py-4 px-6 text-center w-36">Technical Quiz (50M)</th>
                  <th className="py-4 px-6 text-center w-36">IoT Simulation (50M)</th>
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-center">
                        <div className="inline-flex items-center justify-center">
                          {team.rank === 1 ? (
                            <span className="w-8 h-8 rounded-full bg-amber-400 text-slate-950 font-black flex items-center justify-center text-sm shadow-xs">
                              1
                            </span>
                          ) : team.rank === 2 ? (
                            <span className="w-8 h-8 rounded-full bg-slate-300 text-slate-900 font-black flex items-center justify-center text-sm shadow-xs">
                              2
                            </span>
                          ) : team.rank === 3 ? (
                            <span className="w-8 h-8 rounded-full bg-amber-700/80 text-white font-black flex items-center justify-center text-sm shadow-xs">
                              3
                            </span>
                          ) : (
