  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="p-5 rounded-2xl bg-white border border-emerald-100 shadow-xs flex items-center gap-4">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Round 1 Card */}
          <div className="rounded-2xl bg-white border border-emerald-200 shadow-xs p-6 space-y-4 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <span className="text-xs font-semibold text-slate-500"> / 50 Marks</span>
              </div>
            </div>
          ...
          {/* Round 2 Card */}
          <div className="rounded-2xl bg-white border border-teal-200 shadow-xs p-6 space-y-4 relative overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <span className="text-2xl font-black text-teal-800">50</span>
                <span className="text-xs font-semibold text-slate-500"> / 50 Marks</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-emerald-950">
                Round 1 (50 Marks) + Round 2 (50 Marks) = <strong>100 Marks Total</strong>
              </p>
            </div>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-4 rounded-xl bg-white border border-slate-200 space-y-2">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              In the case of identical total scores, the team with the higher <strong>IoT Based Simulation score</strong> will be ranked ahead. If still tied, the Technical Quiz score decides. Evaluator and Committee decisions are final.
            </p>
          </div>
