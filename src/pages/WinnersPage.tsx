        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
            ...
            <div className="order-2 md:order-1">
              <div className="rounded-3xl bg-gradient-to-b from-slate-100 via-white to-slate-50 border-2 border-slate-300 p-6 shadow-sm relative overflow-hidden space-y-4">
                <div className="flex items-center justify-between">
                  <span className="px-3 py-1 rounded-full bg-slate-200 text-slate-800 text-xs font-bold uppercase tracking-wider flex items-center gap-1">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                      <div className="flex justify-between text-xs text-slate-600">
                        ...
                        <strong className="font-mono">{secondPlace.technicalQuizScore} / 50</strong>
                      </div>
                      <div className="flex justify-between text-xs text-slate-600">
                        <span>IoT Simulation</span>
                        <strong className="font-mono">{secondPlace.iotSimulationScore} / 50</strong>
                      </div>
            ...
            <div className="order-1 md:order-2 md:-translate-y-4">
              <div className="rounded-3xl bg-gradient-to-b from-amber-500/15 via-amber-50/50 to-white border-2 border-amber-400 p-7 shadow-xl relative overflow-hidden space-y-5">
                <div className="absolute top-0 right-0 w-32 h-32 bg-amber-400/10 rounded-bl-full pointer-events-none"></div>

                <div className="flex items-center justify-between">
                  <span className="px-3.5 py-1 rounded-full bg-amber-400 text-slate-950 text-xs font-black uppercase tracking-wider flex items-center gap-1.5 shadow-xs">
                    <Crown className="w-4 h-4 text-slate-950" />
                    CHAMPION • 1st Place
                  </span>
                  <div className="w-10 h-10 rounded-full bg-amber-400 text-slate-950 font-black flex items-center justify-center text-lg shadow-sm">
                    1
                  </div>
                </div>
                ...
                {firstPlace ? (
                  <div className="space-y-4">
                    <div>
                      <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-amber-200 text-amber-950">
                    ...
                    <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-300 space-y-1.5">
                      <div className="flex justify-between text-xs text-slate-700">
                        <span>Technical Quiz</span>
                        <strong className="font-mono">{firstPlace.technicalQuizScore} / 50</strong>
                      </div>
                      <div className="flex justify-between text-xs text-slate-700">
                        <span>IoT Simulation</span>
                        <strong className="font-mono">{firstPlace.iotSimulationScore} / 50</strong>
                      </div>
            ...
            <div className="order-3">
              <div className="rounded-3xl bg-gradient-to-b from-amber-900/10 via-white to-amber-50/20 border-2 border-amber-700/30 p-6 shadow-sm relative overflow-hidden space-y-4">
                <div className="flex items-center justify-between">
                ...
                {thirdPlace ? (
                  <div className="space-y-3">
                    ...
                    <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                      <div className="flex justify-between text-xs text-slate-600">
                        <span>Technical Quiz</span>
                        <strong className="font-mono">{thirdPlace.technicalQuizScore} / 50</strong>
                      </div>
                      <div className="flex justify-between text-xs text-slate-600">
                        <span>IoT Simulation</span>
                        <strong className="font-mono">{thirdPlace.iotSimulationScore} / 50</strong>
                      </div>
                      <div className="flex justify-between text-sm font-bold text-slate-900 pt-1 border-t border-slate-200">
                        <span>Total Score</span>
