    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-emerald-100 shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-600 via-teal-700 to-emerald-900 p-0.5 shadow-md shadow-emerald-900/10 flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
              <div className="w-full h-full bg-emerald-950 rounded-[10px] flex items-center justify-center relative overflow-hidden">
                <Leaf className="w-6 h-6 text-emerald-400 absolute opacity-80" />
                <Cpu className="w-4 h-4 text-white z-10 translate-x-1.5 translate-y-1.5" />
              </div>
            </div>

            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-2xl tracking-tight font-display bg-gradient-to-r from-emerald-800 via-emerald-700 to-teal-800 bg-clip-text text-transparent">
                  Euphoria'26
                </span>
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-3.5 py-2 rounded-lg text-xs font-bold tracking-wider uppercase transition-all duration-200 flex items-center gap-1.5 ${
                    isActive
