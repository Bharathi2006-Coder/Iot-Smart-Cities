...
import { Building2, Calendar, Clock, MapPin, Leaf, Award, ShieldCheck } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ onRouteChange }) => {
  return (
    <footer className="bg-slate-900 text-slate-300 border-t border-emerald-950 mt-auto">
      ...
      <div className="h-1.5 bg-gradient-to-r from-emerald-600 via-teal-500 to-emerald-400"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-700/80 flex items-center justify-center text-white shadow-inner">
                <Leaf className="w-5 h-5 text-emerald-300" />
              </div>
              <div>
                <h3 className="text-white font-extrabold text-xl tracking-tight">Euphoria'26</h3>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li className="pt-2">
                <button 
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-900/60 hover:bg-emerald-800 text-emerald-300 font-semibold transition border border-emerald-800"
                >
